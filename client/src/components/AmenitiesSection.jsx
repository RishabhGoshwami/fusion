// src/components/AmenitiesSection.jsx (Optimized Keyword Density)
...
  return (
    <section className="relative py-20 bg-white text-gray-900" id="amenities">
...
        {/* Heading - Targeted Keyword Use (2 times) */}
        <div className="text-center mb-14">
          <h3 className="text-amber-500 text-sm font-semibold uppercase tracking-[0.25em]">
            World-Class Amenities
          </h3>
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">
            Experience <span className="bg-gradient-to-r from-yellow-400 via-amber-300 to-green-400 bg-clip-text text-transparent">Luxury Living</span> at <strong className="text-gray-800">Fusion The Brook and Rivulet</strong>
          </h2>
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            **Fusion The Brook and Rivulet** in **Sector 12, Greater Noida West** offers thoughtfully designed amenities that enhance lifestyle, wellness, and recreation. Every feature is curated to bring luxury and comfort together.
          </p>
        </div>

        {/* Grid of amenities - Clean and Short (Keyword used 0 times here) */}
...
                </div>
              </div>
              <p className="text-gray-700 font-semibold leading-snug pt-1">
                {text}
              </p>
            </div>
          ))}
