        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">
            ...
            <strong className="text-gray-800">
              Fusion The Brook and Rivulet
            </strong>
          </h2>
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            <strong>Fusion The Brook and Rivulet</strong> in{" "}
            <strong>Sector 12, Greater Noida West</strong> offers thoughtfully
            designed amenities that enhance lifestyle, wellness, and recreation.
            Every feature is curated to bring luxury and comfort together.
          </p>
        </div>
